  ...
  const handleConnect = async () => {
    ...
    try {
      ...
      if (authUrl) {
        ...
        throw new Error('Failed to get authorization URL. Make sure the backend is running.');
      }
    } catch (err) {
  ...
  return (
    <div style={{ minHeight: '100vh', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', padding: '48px 24px', position: 'relative' }}>
      ...
      <div style={{ textAlign: 'center', marginBottom: 48 }}>
        ...
        >
          connect your account to sync your music and get personalized recommendations
        </p>
      </div>
