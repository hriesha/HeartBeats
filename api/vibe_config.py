...
VIBE_DEFINITIONS: List[Dict[str, Any]] = [
    ...
    },
    {
        ...
        "search_keywords": ["electronic", "edm hits", "edm workout", "electro dance"],
        "color": "#64D2FF",
    ...
    },
    {
        ...
        "search_keywords": ["dance", "dance hits", "dance workout", "club hits"],
        "color": "#30D158",
    ...
    },
    {
        ...
        "name": "R&B Groove",
        "genre_id": GENRE_RNB,
        "search_keywords": ["rnb", "r&b", "r&b hits", "r&b groove"],
        "color": "#BF5AF2",
